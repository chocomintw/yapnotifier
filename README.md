...
- **INSERT** opens the config menu (rebind it on the menu's Keys tab, or `menu_key` in the INI as a Windows virtual-key code). While it is open the game's mouse is released; close it with INSERT again or the menu's ×.
